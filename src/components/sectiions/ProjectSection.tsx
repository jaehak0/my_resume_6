          ...
          <div className='project-card'>
            <div className='bg-white p-8 border-b border-slate-200 relative'>
              ...
              <p className='text-slate-600 mb-4'>
                LLM 기반 기업 신용평가 및 자동 보고서 생성 시스템
              </p>
            ...
            <div className='p-8'>
              ...
              <div className='project-details'>
                ...
                <br />
                • 신용평가 정확도 개선: 자본잠식 기업 A+ 문제 해결을 위한 룰베이스 검증 + Agent 기반
                2차 검증 시스템 구축
                <br />• 실시간 피드백: Server-Sent Events (SSE) 기반 사용자 피드백 시스템 구현
              </div>
          ...
          <div className='project-card'>
            ...
            <div className='p-8'>
              ...
              <div className='project-details'>
                ...
                <br />
                • 기획 단계 의견 조율: 팀원들의 서로 다른 이해도를 통일하기 위해 화면설계,
                기능상세서 작성
                <br />
              ...
              <div className='project-details'>
                ...
                <br />• 커스텀 캘린더: 라이브러리 기반 캘린더를 프로젝트 요구사항에 맞게
                커스터마이징
              </div>
          ...
          <div className='project-card'>
            ...
            <div className='p-8'>
              <div className='project-details mb-6'>
                <strong>핵심 경험:</strong>
                <br />• <strong>LLM 파인튜닝:</strong> LoRA 기법으로 LLaMA 3.2 3B 모델 파인튜닝, 92%
                정확도 달성
